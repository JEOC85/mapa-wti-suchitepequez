...
map.getView().fit([-10205152.560932, 1610912.360786, -10142616.228135, 1652100.412231], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">INDICE DE HUMEDAD TOPOGRAFICA SUCHITEPEQUEZ</h2>';
        return titleElement;
    })(),
